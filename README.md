...
calc
```
Минималистичный калькулятор с возможностью решать простые выражения со знаками: + - * / ** и так далее "усовершенственную версию можно скачать через пакетный менеджер [MicroOs Packet Manager](https://github.com/happin92/MicroOs-Packet-manager)"
